#ifndef __OSCILLATORPLOTVIEW_H__
#define __OSCILLATORPLOTVIEW_H__

#include <WaveSabreVstLib.h>
using namespace WaveSabreVstLib;


class OscillatorPlotView : public CView
{
public:
	OscillatorPlotView (Vectron *vectron, const CRect &size)
		: CView(size)
		, vectron(vectron)
	{
	}

	virtual ~OscillatorPlotView()
	{
	}
